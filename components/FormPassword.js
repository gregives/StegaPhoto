const FormPassword = ({ value, confirm, onChange, onConfirm, valid }) => (
    <div className="-mx-4 grid md:grid-cols-2 gap-8">
        ...
        <div className="relative">
            <input
                className={`bg-gray-900 bg-opacity-25 placeholder-gray-700 rounded-lg shadow-inner focus:outline-none focus-visible:shadow-outline md:text-3xl w-full px-4 py-2 border-2 ${
